...
echo "Writing rootfs only on NAND without erasing NAND"
sudo qemu-amd64 -L /usr/x86_64-linux-gnu/ ${samba_path}/sam-ba_64 /dev/ttyACM0 at91sam9g20-ek rootfs.tcl ${br_images_path}
