...
mv S50dropbear K50dropbear 2>/dev/null
mv S20urandom K20urandom 2>/dev/null
...
echo "none            /sys/kernel/tracing     tracefs rw,relatime,seclabel,noauto 0 0" >> $1/etc/fstab
