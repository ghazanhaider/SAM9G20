...
files=( "boot.bin" "u-boot.bin" "uboot-env.bin" "zImage" "rootfs.ubi" )
...
sudo qemu-amd64 -L /usr/x86_64-linux-gnu/ ${samba_path}/sam-ba_64 /dev/ttyACM0 at91sam9g20-ek samba_at45_write.tcl ${br_images_path}

echo "Erasing and flashing NAND"
sudo qemu-amd64 -L /usr/x86_64-linux-gnu/ ${samba_path}/sam-ba_64 /dev/ttyACM0 at91sam9g20-ek samba_nand_2.6_write.tcl ${br_images_path}
